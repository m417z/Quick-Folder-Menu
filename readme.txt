Quick Folder Menu
https://ramensoftware.com/quick-folder-menu
-------------------------------------------

Usage:
qfmenu.exe folder

The folder can either be a path or a CSIDL identifier.

Examples:
qfmenu.exe C:\
qfmenu.exe "D:\New Folder"
qfmenu.exe 0x0011

Available CSIDL identifiers (from shlobj.h):
